...
public class OTRSKeHuWebActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_otrske_hu_web);
        ...
        webView = (WebView)findViewById(R.id.wv_otrsKeHu);
        ...
        webView.postUrl("https://imotom01.dd.ezbox.cc:34443/otrs/customer.pl",postData.getBytes());
    }
