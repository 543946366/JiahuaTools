package com.jiahua.jiahuatools.model;
/*
...
public class SetWifiStaSettingsModel implements ISetWifiStaSettingsModel {
    ...
    public void submit(String ssid, String ssidPassword, String ip, OnSubmitListener onSubmitListener) {
        WifiStaSettingsJson wifiStaSettingsJson = new WifiStaSettingsJson();
        wifiStaSettingsJson.setSsid(ssid);
        wifiStaSettingsJson.setPassword(ssidPassword);
        String ss = new GsonBuilder().create().toJson(wifiStaSettingsJson, WifiStaSettingsJson.class);
